...
import type { APIApplication, APIApplicationCommand, APIApplicationCommandInteraction, APIChannel, APIEmoji, APIGuild, APIGuildIntegration, APIGuildMember, APIMessage, APIRole, APIUnavailableGuild, APIUser, GatewayActivity, GatewayPresenceUpdate as RawGatewayPresenceUpdate, GatewayVoiceState, InviteTargetType, PresenceUpdateStatus } from '../payloads/v8/index';
export * from './common';
export declare const GatewayVersion = "8";
/**
 * https://discord.com/developers/docs/topics/opcodes-and-status-codes#gateway-gateway-opcodes
 */
export declare const enum GatewayOPCodes {
    /**
 ...
 */
export declare const enum GatewayCloseCodes {
    /**
 ...
 */
export declare const enum GatewayDispatchEvents {
 ...
 */
export declare type GatewayApplicationCommandModifyDispatch = DataPayload<GatewayDispatchEvents.ApplicationCommandCreate | GatewayDispatchEvents.ApplicationCommandUpdate | GatewayDispatchEvents.ApplicationCommandDelete, GatewayApplicationCommandModifyDispatchData>;
/**
 * https://discord.com/developers/docs/topics/gateway#application-command-create
 * https://discord.com/developers/docs/topics/gateway#application-command-update
 * https://discord.com/developers/docs/topics/gateway#application-command-delete
 ...
 * https://discord.com/developers/docs/topics/gateway#application-command-create
 */
export declare type GatewayApplicationCommandCreateDispatch = GatewayApplicationCommandModifyDispatch;
/**
 * https://discord.com/developers/docs/topics/gateway#application-command-create
 */
export declare type GatewayApplicationCommandCreateDispatchData = GatewayApplicationCommandModifyDispatchData;
/**
 * https://discord.com/developers/docs/topics/gateway#application-command-update
 */
export declare type GatewayApplicationCommandUpdateDispatch = GatewayApplicationCommandModifyDispatch;
/**
 * https://discord.com/developers/docs/topics/gateway#application-command-update
 */
export declare type GatewayApplicationCommandUpdateDispatchData = GatewayApplicationCommandModifyDispatchData;
/**
 * https://discord.com/developers/docs/topics/gateway#application-command-delete
 */
export declare type GatewayApplicationCommandDeleteDispatch = GatewayApplicationCommandModifyDispatch;
/**
 * https://discord.com/developers/docs/topics/gateway#application-command-delete
 */
export declare type GatewayApplicationCommandDeleteDispatchData = GatewayApplicationCommandModifyDispatchData;
/**
 ...
 */
export declare type GatewayGuildModifyDispatch = DataPayload<GatewayDispatchEvents.GuildCreate | GatewayDispatchEvents.GuildUpdate, GatewayGuildModifyDispatchData>;
/**
 * https://discord.com/developers/docs/topics/gateway#guild-create
 * https://discord.com/developers/docs/topics/gateway#guild-update
 */
 ...
 * https://discord.com/developers/docs/topics/gateway#guild-create
 */
export declare type GatewayGuildCreateDispatchData = GatewayGuildModifyDispatchData;
/**
 * https://discord.com/developers/docs/topics/gateway#guild-update
 */
 ...
 * https://discord.com/developers/docs/topics/gateway#guild-member-update
 */
export declare type GatewayGuildMemberUpdateDispatchData = Omit<APIGuildMember, 'deaf' | 'mute' | 'user'> & Partial<Pick<APIGuildMember, 'deaf' | 'mute'>> & Required<Pick<APIGuildMember, 'user'>> & {
    /**
     * The id of the guild
     */
    guild_id: Snowflake;
 ...
 * https://discord.com/developers/docs/topics/gateway#interaction-create
 */
export declare type GatewayInteractionCreateDispatchData = APIApplicationCommandInteraction;
/**
